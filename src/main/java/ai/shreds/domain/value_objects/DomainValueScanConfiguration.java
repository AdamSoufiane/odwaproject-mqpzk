 ...
 * for executing a security scan.
 */
@Value
@Builder
@Getter(AccessLevel.PUBLIC)
public class DomainValueScanConfiguration {
     ...
     */
    public DomainValueScanConfiguration(List<String> targetUrls, String credentials,
     ...
     */
    public DomainValueScanConfiguration withNewDepth(int newDepth) {
        return new DomainValueScanConfiguration(targetUrls, credentials, newDepth, schedulingMetadata);
    }
     ...
     * @return A new configuration instance
     */
    public DomainValueScanConfiguration withNewCredentials(String newCredentials) {
        return new DomainValueScanConfiguration(targetUrls, newCredentials, scanningDepth, schedulingMetadata);
    }
     ...
     * @return A new configuration instance
     */
    public DomainValueScanConfiguration withAdditionalUrls(List<String> additionalUrls) {
        ...
        return new DomainValueScanConfiguration(newUrls, credentials, scanningDepth, schedulingMetadata);
    }
}
