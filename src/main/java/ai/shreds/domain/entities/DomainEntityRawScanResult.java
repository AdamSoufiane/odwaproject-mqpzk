...
public class DomainEntityRawScanResult {
    ...
    public DomainEntityRawScanResult(String id, String scanTaskId, 
                                    List<String> vulnerabilityFindingsList,
                                    String timestamp, List<String> scanExecutionLogs) {
        this.id = id;
        ...
        this.findings = new DomainValueScanFindings();
        this.findings.setFindingDetails(vulnerabilityFindingsList);
    ...
    public void addVulnerabilityFinding(String finding) {
        ...
        this.findings.setFindingDetails(this.vulnerabilityFindingsList);
    }
